...
deadtext = deadfont.render('Du er dau.', True, red, blue)
...
def setup_level_1(player, enemies, walls):
    player.rect.center = (10*tile, 10*tile)

    enemies.clear()
    for i in range(1, 5):
        enemies.append(Enemy(i*4, 5))
        enemies.append(Enemy(i*4, 15))
...
def setup_level_2(player, enemies, walls):
    ...
    for i in range(20):
        walls.append(Wall(4, i+4))
        walls.append(Wall(12, i+4))
        walls.append(Wall(8, i-3))
        walls.append(Wall(16, i-3))

    enemies.clear()
    for i in range(2, 20, 4):
        enemies.append(Enemy(i, 2))
        enemies.append(Enemy(i, 10))
        enemies.append(Enemy(i, 18))
    enemies.pop(2)



setup_level_1(player, enemies, walls)
...
while running and not quitted:
    ...
    if len(enemies) == 0:
        if cur_level == 1:
            setup_level_2(player, enemies, walls)
            cur_level = 2
